...
class KPathContainer(PathContainer):
    ...
    def merge(self, to_add: Union[Path, PathContainer, KPathContainer], override_k=False, **kwargs):
    ...
    def path(self, source: Hashable, target: Hashable, t_start: Number, mode: str, k: int, **kwargs) -> Path:
        raise NotImplementedError()
