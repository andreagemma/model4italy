...
class BaseWriter(ABC):
    ...
    def __init__(self, params: Union[str, dict], settings: IniClass=None, loader: BaseLoader=None, default_ext=".dat"):
    ...
    def get_name(self, name, **kwargs):
        return self.loader.get_name(name, **kwargs)
    ...
    def get_location_src(self, param, **kwargs):
        ...
        if location is not None:
            location = self.get_name(location, **kwargs)
    ...
    def get_cls_by_name(class_name) -> BaseWriter:                
        module = import_module("libs.writers")
