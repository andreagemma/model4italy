...
class RTServer:
    ...
    def clean(self, t_end: datetime) -> None:
        ...
        horizon = timedelta(minutes=self.parser.ini.FCD_SERVER_FCD_HORIZON)
    ...
    def load_fcd_by_timetamp(self, t_start: datetime, t_end: datetime) -> pd.DataFrame:
        ...
        df_fcd: pd.DataFrame = self.build_paths.load_fcd_by_timestamp(t_start=t_start, t_end=t_end, crs_data=self.parser.ini.FCD_SERVER_FCD_CRS_DATA)
