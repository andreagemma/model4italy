...
def monitor_process(process_name: str = "python", interval: float = 1.0, output_file: str = None, directory: str = "."):
    """
    ...
    try:
        while True:
            ...
            with open(output_file_path, mode="a", newline="") as csv_file:
                ...
                file_exists = True
                writer.writerow([timestamp, process_name, round(memory_usage/1024/1024,1), cpu_usage])
