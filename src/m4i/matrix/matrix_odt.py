...
class MatrixODT:
    def __init__(
        ...
        cols: List,
        timestamps: List,
        init: Optional[Dict[MatrixOD, MatrixODT]] = None,
        copy: bool = False,
    ...
    def read_df(
        ...
        grouped = (
            df[[o_field, d_field, value_field, timestamp_field]]
            .rename(columns={o_field: "o", d_field: "d", value_field: "value"})
            .groupby(timestamp_field, group_keys=False, observed=False)
        )
                    ...
                    data.append(
                        {
                            ...
                            "o": o_key,
                            "d": d_key,
                            "value": od_matrix.mat[o_index, d_index],
                        }
                    )
