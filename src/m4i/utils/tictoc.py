...
class TicToc:
    ...
    def remaining_time(
        ...
        tot: Optional[Union[int, float]] = None,
    ) -> TicTocInterval:
        """
    ...
    def info(
        self,
        iformat=None,
        counter: Optional[Union[int, float]] = None,
        tot: Optional[Union[int, float]] = None,
    ...
    def get_info(
        self,
        iformat=None,
        counter: Optional[Union[int, float, str]] = None,
        tot: Optional[Union[int, float]] = None,
        dt_format="%Y-%m-%d %H:%M:%S",
        logger: logging.Logger = None,
        **kwargs,
        ...
        try:
            ...
            vals = [
                ...
                {
                    "aliases": ("v", "speed"),
                    "expr": "self.speed(counter) if counter is not None else None",
                    "def": "h",
                    "units": ("s", "m", "h", "d", "str"),
                },
                {
                    "aliases": ("rt", "remaining_time"),
                    "expr": "self.remaining_time(counter, tot) if counter is not None and tot is not None else None",
                    "def": "str",
                    "units": ("s", "m", "h", "d", "str"),
                },
                {
                    "aliases": ("tt", "total_time"),
                    "expr": "self.total_time(counter, tot) if counter is not None and tot is not None else None",
                    "def": "str",
                    "units": ("s", "m", "h", "d", "str"),
                },
                {
                ...
                {
                    "aliases": ("start", "start_time"),
                    "expr": "self.start_time()",
                    "def": "str",
                    "units": ["str"],
                },
                {
                    "aliases": ("origin", "origin_time"),
                    "expr": "self.origin_time()",
                    "def": "str",
                    "units": ["str"],
                },
            ]
